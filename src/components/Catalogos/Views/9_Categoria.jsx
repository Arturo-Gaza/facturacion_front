...
import Acciones from "../Actions/9_Categoria"; //###
//ICONOS
...
const Afectacion = (props) => {
  ...
  const [titulo, setTitulo] = useState("Categoría"); //### **
  ...
  const descargarExcel = () => {
    props.props.setOpenLoadingScreen();
    requests
      .postToken(GET_CATEGORIA_EXCEL, search0) //### **
      .then((response) => {
        // props.props.setMessageSnackBar(response.data.message, 'success');
  ...
  if (ascNombre == true) {
    results = results.sort((a, b) =>
      a.descripcion_categoria.localeCompare(b.descripcion_categoria)
    ); //### **
  }

  if (descNombre == true) {
    results = results.sort((a, b) =>
      b.descripcion_categoria.localeCompare(a.descripcion_categoria)
    ); //### **
  }
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="center">
                <label className="textLabel3">Tipo</label>
              </StyledTableCell>
