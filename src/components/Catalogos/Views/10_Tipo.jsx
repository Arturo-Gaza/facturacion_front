...
//ACCIONES
import { GET_LIST_TIPO, GET_TIPO_EXCEL } from '../../../Constants/ApiConstants';
import AlertaFilter from "../../../alerts/FilterCatalogos";
import requests from '../../AxiosCalls/AxiosCallsLocal';
import Acciones from '../Actions/10_Tipo'; //###
//ICONOS 
...
const Afectacion = (props) => {
    ...
    const descargarExcel = () => {
        props.props.setOpenLoadingScreen();
        requests
            .postToken(GET_TIPO_EXCEL, search0) //### **
            .then((response) => {
                // props.props.setMessageSnackBar(response.data.message, 'success');
    ...
    if (ascNombre == true) {
        results = results.sort((a, b) => a.descripcion.localeCompare(b.descripcion)); //### **
    }

    if (descNombre == true) {
        results = results.sort((a, b) => b.descripcion.localeCompare(a.descripcion)); //### **
    }
        ...
        <div style={{ padding: '1%' }}>
            ...
            <TableContainer component={Paper} >
                <Table sx={{ minWidth: 80, maxHeight: '300px', }} aria-label="customized table">
                    <TableHead>
                        <TableRow>
                            <StyledTableCell align="center"><label className='textLabel3'>Descripción</label>
                            ...
                            <StyledTableCell align="center">
                                <label className='textLabel3'>Requiere marca modelo</label>
                            </StyledTableCell>
                            ...
                            <StyledTableCell align="center" width="15%">
                                ...
                                <Tooltip title="Filtrar por Estatus">
                                    <IconButton onClick={porHabilitado} style={{ width: "30px", height: "30px" }}>
                                        <FilterAltIcon sx={{ color: "black" }} style={{ width: "20px", height: "20px", }} />
                                    </IconButton>
                                </Tooltip>
                            </StyledTableCell>
