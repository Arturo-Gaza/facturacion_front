...
const Afectacion = (props) => {
    ...
    const [titulo, setTitulo] = useState("Usuarios")//### ** 

    const handleOpenUser = (id, nombre) => {
    ...
    if (!search0 && !search1) {
        ...
        if (search0 != "") {
            results = results.filter((dato) =>
                dato.name.toLowerCase().includes(search0.toLocaleLowerCase() ||
                    dato.descripcio_depatamento.toLowerCase().includes(search0.toLocaleLowerCase())
                ) //### **
            );
        }
                    ...
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell align="center">
                                <label className='textLabel3'>Nombre</label>
                            </StyledTableCell>
                            <StyledTableCell align="center">
                                <label className='textLabel3'>Apellido paterno</label>
                            </StyledTableCell>
                            <StyledTableCell align="center">
                                <label className='textLabel3'>Apellido materno</label>
                            </StyledTableCell>
                            <StyledTableCell align="center">
                                <label className='textLabel3'>Correo electrónico</label>
                            </StyledTableCell>
                            <StyledTableCell align="center">
                        ...
                        {results.slice(inicio, fin).map((item) => {
                            return (
                                ...
                                >
                                    ...
                                    <StyledTableCell>
                                        <label className='textLabel4'>{item.name}</label> {/* //### ** */}
                                    </StyledTableCell>
                                    <StyledTableCell>
                                        <label className='textLabel4'>{item.apellidoP}</label> {/* //### ** */}
                                    </StyledTableCell>
                                    <StyledTableCell>
                                        <label className='textLabel4'>{item.apellidoM}</label> {/* //### ** */}
                                    </StyledTableCell>
                                    <StyledTableCell>
                                        <label className='textLabel4'>{item.email}</label> {/* //### ** */}
                                    </StyledTableCell>
                                    <StyledTableCell>
                                        <label className='textLabel4'>{item.rol.nombre}</label> {/* //### ** */}
                                    </StyledTableCell>
                                    <StyledTableCell>
                                    ...
                                    <StyledTableCell align="center">
                                        ...
                                        {item.user == "Admin" ? (null) : (
                                            <IconButton
                                                aria-label="editar"
                                                color="primary"
                                                onClick={function () {
                                                    handleOpenUser(item.id, item.user); {/* //### ** */ }
                                                }}
                                            >
                                                <DeleteForeverIcon sx={{ color: "#ff0000" }} />
                                            </IconButton>
                                        )}
                                    </StyledTableCell>
                                </StyledTableRow>
