...
import { CREATE_OBSERVACIONES_SOLICITUD, UPDATE_ESTATUS_SOLICITUDES } from '../Constants/ApiConstants';
...
const AlertaCerrarSolicitud = (props) => {
    ...
    const Continuar = () => {
        ...
        const dataObservacion = {
            ...
            observacion: 'Motivo de conclusión: ' + observacion,
        ...
        requests
            ...
            .then(() => {
                CambioEstatus(4, props.solicitudItem.id);
                setObservacion("");
                setStep(1);
            })
            .catch((error) => {
                    ...
                    <Grid>
                        <DialogContent >
                            {step === 1 && (
                                <center>
                                    <p style={{ fontWeight: '700', fontSize: '1.2rem' }}>
                                        ¿Quieres concluir el ticket?
                                    </p>
                                    <Box sx={{ mt: 2, display: 'flex', justifyContent: 'center' }}>
                                        <Button className='btn-aceptar' onClick={ContinuarSig} variant={"contained"} sx={{ mr: 1 }}>Continuar</Button>
                            ...
                            {/* {step === 2 && (
                                <center>
                                    <p style={{ fontWeight: '700', fontSize: '1.2rem' }}>
                                        ¿Estás seguro de que deseas concluir el ticket?
                                    </p>
                                    <Box sx={{ mt: 2, display: 'flex', justifyContent: 'center' }}>
                            ...
                            {step === 2 && (
                                <center>
                                    <p style={{ fontWeight: "700", fontSize: "1.2rem" }}>
                                        ¿Estás seguro de que deseas concluir el ticket? <br />
                                        Ingresa un motivo
                                    </p>
                                    <textarea
                                        cols="50"
